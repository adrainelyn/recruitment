# Generated by Django 2.0.1 on 2022-12-17 16:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(max_length=135, verbose_name='手机号码')),
                ...
                ('first_score', models.DecimalField(blank=True, decimal_places=1, help_text='1-5分，极优秀: >=4.5，优秀: 4-4.4，良好: 3.5-3.9，一般: 3-3.4，较差: <3分', max_digits=3, null=True, verbose_name='初试分')),
                ('first_learning_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='学习能力得分')),
                ('first_profession_competency', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='专业能力得分')),
                ...
                ('second_score', models.DecimalField(blank=True, decimal_places=1, help_text='1-5分，极优秀: >=4.5，优秀: 4-4.4，良好: 3.5-3.9，一般: 3-3.4，较差: <3分', max_digits=3, null=True, verbose_name='专业复试得分')),
                ('second_learning_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='学习能力得分')),
                ('second_profession_competency', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='专业能力得分')),
                ...
                ('second_interviewer', models.CharField(blank=True, max_length=256, verbose_name='二面面试官')),
                ('second_remark', models.CharField(blank=True, max_length=135, verbose_name='专业复试备注')),
                ('HR_score', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='HR复试综合等级')),
                ...
                ('HR_remark', models.CharField(blank=True, max_length=256, verbose_name='HR面试备注')),
                ('creator', models.CharField(blank=True, max_length=256, verbose_name='候选人数据创建人')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('modifed_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='更新时间')),
